...
export const ConsultationForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch("https://formspree.io/f/mzdapdrr", {
        method: "POST",
        body: data,
        headers: {
              ...
              <div className="space-y-3 pt-4">
                  <div className="flex items-center gap-4">
                      ...
                      <div>
                          ...
                          <a href="tel:15999667" className="text-2xl font-black block hover:opacity-80 transition-opacity md:pointer-events-none md:cursor-default">1599-9667</a>
                      </div>
                  </div>
                  <div className="flex items-center gap-4">
                      <div className="w-10 h-10 bg-black text-yellow-400 rounded-full flex items-center justify-center">
